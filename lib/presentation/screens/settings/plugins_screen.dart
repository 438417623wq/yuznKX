      ...
      body: ListView(
        children: [
          ...
          _buildPluginTile(
            ...
            '记忆卡片瀑布流',
            '以瀑布流卡片形式展示记忆条目。',
            plugins['memory_masonry'] ?? true,
            (val) => notifier.toggle('memory_masonry'),
          ...
          _buildPluginTile(
            ...
            '记忆时间线',
            '按时间顺序展示记忆节点。',
            plugins['memory_timeline'] ?? true,
            (val) => notifier.toggle('memory_timeline'),
            Icons.timeline,
          ),
          _buildPluginTile(
            context,
            '记忆控制台',
            '显示记忆统计与全局控制。',
            plugins['memory_dashboard'] ?? true,
            (val) => notifier.toggle('memory_dashboard'),
            Icons.analytics,
          ),
          _buildPluginTile(
            context,
            '向量检索视图',
            '展示记忆条目的语义关联与图谱。',
            plugins['memory_vector'] ?? true,
            (val) => notifier.toggle('memory_vector'),
            Icons.hub,
          ),
          const Divider(),
          _buildPluginTile(
